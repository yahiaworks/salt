...
LDAPJENKINSVBU_PASSWORD_KEY="\[LDAPJENKINSVBU_PASSWORD\]"
...
function main {
    ...
    replace_value "$LDAPJENKINSVBU_PASSWORD_KEY" $LDAPJENKINSVBU_PASSWORD $MASTER_FILENAME
}
...
function check_env_vars {
    ...
    check_env_var "LDAPJENKINSVBU_PASSWORD" $LDAPJENKINSVBU_PASSWORD
}
